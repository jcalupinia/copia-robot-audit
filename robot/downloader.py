...
# Helpers de bajo nivel para parsing de PDF (Sub-fase 3b-A): lectura,
# extracción por regex y por layout. Se re-importan porque los parsers
# principales (_extraer_datos_pdf*) que siguen en downloader.py los usan.
